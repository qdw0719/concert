...
import com.hb.concert.concert.converter.SeatIdConverter;
import com.hb.concert.common.enumerate.UseYn;
import com.hb.concert.common.enumerate.ValidState;
...
@Entity @Table(name = "HB_CONCERT_RESERVATION"
        , indexes = { @Index(name = "idx_concert_reservation", columnList = "concertDetailId, reservationTime") }
)
